...
| **Operators** — 8 planned | **Real** — all 8 implemented, unit-tested on fixture programs |
...
Currently 10 tests, all green. The demo program (`demo/demo-vault`) carries its
own Anchor/LiteSVM test suite that exercises its instructions. Nothing on this
site or in this README is sample data; the report panel stays empty until a real
run exists.
